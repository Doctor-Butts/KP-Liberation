...
force ace_hearing_unconsciousnessVolume = 0.8;
...
// ACE Magazine Repack
force ace_magazinerepack_timePerAmmo = 1.2;
force ace_magazinerepack_timePerBeltLink = 7;
force ace_magazinerepack_timePerMagazine = 1.8;
...
force ace_medical_blood_enabledkFor = 2;
...
force ace_medical_menu_maxRange = 2.5;
...
// ACE Nightvision
force ace_nightvision_aimDownSightsBlur = 0.115866;
ace_nightvision_disableNVGsWithSights = false;
force ace_nightvision_effectScaling = 0.187167;
force ace_nightvision_fogScaling = 0.187167;
force ace_nightvision_noiseScaling = 0.525847;
...
force ace_finger_indicatorColor = [1,0,1,1];
...
acre_sys_core_ts3ChannelPassword = "In Operation (ACRE)";
